  ...
  secrets: [
    {
      ...
      icon: "⚔️",
      description: "A cumule 20 heures de visionnage sur un meme week-end",
      condition: (data) => false,
      conditionText: "Cumuler 20 heures de visionnage sur un seul week-end",
    ...
    },
    {
      ...
      icon: "🛌",
      description: "A regarde un contenu le 31 decembre",
      condition: (data) => false,
      conditionText: "Regarder un contenu le 31 decembre",
    ...
    },
    {
      ...
      icon: "🌙",
      description: "A lance un contenu entre 00h00 et 00h59",
      condition: (data) => false,
      conditionText: "Lancer un contenu entre 00h00 et 00h59",
      getProgress: (data) => ({ current: 0, total: 1, percent: 0 }),
      unlockedDate: null,
      category: "secrets",
      isSecret: false,
    ...
    },
    {
      ...
      icon: "⚡",
      description: "A effectue 1000 lectures en Direct Play",
      condition: (data) => false,
      conditionText: "Effectuer 1000 lectures en Direct Play",
